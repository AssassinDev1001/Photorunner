...
"<div style='font-size:14px; text-align:left; font-family:arial;'>Team<br/>Photo Runner</div>".
	...
	"<div style='font-size:15px; font-weight:bold; width:180px; float:left; font-family:arial; text-align:left; margin-left:20px;'></div><div style='font-size:15px; width:420px;'><img src='".$image1234."".$galleryname1->printfile."' style='width:280px; height:200px; margin:10px;' /></div>".
	...
	public function updatephoto( $data, $filesdata )
	{
		if(!empty( $data ) )
		{
			...
			if(!empty($name) && !empty($category) && !empty($gallery) && !empty($webfileprice))   
			{
				...
				$query = "UPDATE pr_photos SET name = '".$name."', category='".$category."',gallery='".$gallery."', $files webfileprice ='".$webfileprice."',printfileprice ='".$printfileprice."',printfilepricea3 ='".$printfilepricea3."',printfilepricea4 ='".$printfilepricea4."',printfilepricea5 ='".$printfilepricea5."', webfilepriceeuro ='".$webfilepriceeuro."',printfilepricea3euro ='".$printfilepricea3euro."',printfilepricea4euro ='".$printfilepricea4euro."',printfilepricea5euro ='".$printfilepricea5euro."',otherpriceeuro ='".$otherpriceeuro."',othertitle ='".$othertitle."',otherprice ='".$otherprice."' WHERE id = '".base64_decode($_GET['id'])."' AND seller = '".$_SESSION['seller']['id']."'";
				if(mysqli_query($this->_con, $query))
				{
