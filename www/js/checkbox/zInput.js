...
$.each(inputNames, function(index,value){
	...
	if (elementType == "radio"){
		$element.wrap(function(){ return '<div class="zInput" id="select"><span style="display:table;width: 100%;height: 100%;"><span style="display: table-cell;vertical-align:middle;">' + $(this).attr("title") + '</span></span></div>'});
	}
