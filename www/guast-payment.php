...
if(isset($_GET['delete']))
{
	...
	header('location:guast-payment.php');	
}
...
<div class="container" style="background-color:#ffffff;">
	<div class="module form-module" style="max-width: 95%; border-top:0px; height:0px;">
		<?php if(!empty($_SESSION['app']['url'])) { ?>
		<div style="margin-top:25px; margin-bottom:15px; margin-left:15px; float:left;"><a href="<?php echo $_SESSION['app']['url']; ?>" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; text-decoration:none; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Back To Gallery</a></div>
		<?php } else{ ?>
		<div style="margin-top:25px; margin-bottom:15px; margin-left:15px; float:left;"><a href="galleries.php" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; text-decoration:none; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Back To Gallery</a></div>
		<?php } ?>
			...
			if(!empty($_SESSION['cart']))
			{
				...
				foreach($_SESSION['cart'] as $key=>$value)
				{
					...
					<div class="col-md-12 payment_box_123" id="">
						<div>
							<div class="col-md-2" style="padding:10px;"><img src="<?php echo APP_URL; ?>uploads/photos/bigwatermark/<?php echo $view->webfile; ?>" style="width:auto; height:110px;" /></div>
...
<?php } ?>*/ ?>
			...
			<div style="font-size:20px; padding:10px; text-align:right; color:#000000; margin-bottom:10px;"><?php if($value['size'] == 'nosize') { ?>Normal Size<?php } ?><?php if($value['size'] == 'A3') { ?>A3 Size<?php } ?><?php if($value['size'] == 'A4') { ?>A4 Size<?php } ?><?php if($value['size'] == 'A5') { ?>A5 Size<?php } ?><?php if($value['size'] == 'othertitle') { ?><?php echo $view->othertitle; ?><?php } ?></div>
			<div class="col-md-12">
