	...
	<div class="col-md-9 features features-right padding_account" style="margin:20px 0;">
		<div class="col-md-12 form-module" style="max-width: 100%;">
			...
			<div id="filerowsdiv">
				...
				<div style="clear:both; height:10px;"></div>
				<?php /*<label style="padding-left:8px;">Print File Photo</label> ( Best size 1200*800 )<br/>
				 Maximum uploaded pictures size should be less than 10mb at once
				<div style="clear:both; height:10px;"></div>
			...
			<div id="div">
				...
				<div style="clear:both"></div>
				<div style="width:40%; float:left"><input type="text" placeholder="Price in $" name="webfileprice" value="" style="width:100%;" class="number_only" id="webfileprice" /></div>
				<div style="width:40%;float:left"><input type="text" placeholder="Price in &#8364;" name="webfilepriceeuro" value="" style="width:100%;" class="number_only" id="webfilepriceeuro" /></div>
				<div style="clear:both"></div>
				...
				<div style="clear:both"></div>
				<div style="width:40%; float:left"><input type="" placeholder="Price in $" name="printfilepricea3" value="" style="width:100%;" id="printfilepricea3" class="number_only"/></div>
				<div style="width:40%;float:left"><input type="" placeholder="Price in &#8364;" name="printfilepricea3euro" value="" style="width:100%;" id="printfilepricea3euro" class="number_only"/></div>
				<div style="clear:both"></div>
				<label style="padding-left:8px;">A4 Print File Price in USD and EURO</label>
				<div style="clear:both"></div>
				<div style="width:40%; float:left"><input type="" placeholder="Price in $" name="printfilepricea4" value="" style="width:100%;" id="printfilepricea4" class="number_only"/></div>
				<div style="width:40%;float:left"><input type="" placeholder="Price in &#8364;" name="printfilepricea4euro" value="" style="width:100%;" id="printfilepricea4euro" class="number_only"/></div>
				<div style="clear:both"></div>

				<label style="padding-left:8px;">A5 Print File Price in USD and EURO</label>
				<div style="clear:both"></div>
				<div style="width:40%;float:left"><input type="" placeholder="Price in $" name="printfilepricea5" value="" style="width:100%;" id="printfilepricea5" class="number_only"/></div>
				<div style="width:40%;float:left"><input type="" placeholder="Price in &#8364;" name="printfilepricea5euro" value="" style="width:100%;" id="printfilepricea5euro" class="number_only"/></div>
				<div style="clear:both"></div>
