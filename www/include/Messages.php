...
class Cl_Messages {
	...
	var $msgClass = 'alert alert-';
	var $msgWrapper = "<div class='%s%s alert-dismissable'>\n%s</div>\n";
	var $msgBefore = '<p>';
	var $msgAfter = "</p>\n";
	...
	function translate1($serviceno, $servicepwd, $text, $srclang, $trglang) {
		...
		return $this->do_post_request1($host, $params);
	}

	function do_post_request1($url, $data, $optional_headers = null) {
