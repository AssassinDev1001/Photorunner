...
if(isset($_POST['remove']))
{
	...
	if($common->delete('pr_seller',$conditions))
	{
		$common->redirect(APP_URL."photographer.php");
	}
	else
	{
...
{
	$conditions = array('id'=>$_POST['id']);
	if($common->activateseller('pr_seller',$conditions))
	{
		$common->redirect(APP_URL."photographer.php");
	}
	else
...
{
	$conditions = array('id'=>$_POST['id']);
	if($common->deactivateseller('pr_seller',$conditions))
	{
		$common->redirect(APP_URL."photographer.php");
	}
	else
...
if(isset($_POST['search']))
{
	...
	if((!empty($search_from)) && (!empty($search_to)))
	{
		...
		else
		{
			...
			$ref_sql = 'AND user_type="seller"';
		}
		
	}
	if((empty($search_from)) && (empty($search_to)) && (empty($email)) && (empty($username)))
	{
		$ref_sql = 'where type="seller"';
	}

	$tables = array('pr_seller');
...
else
{
	...
	$members = $common->getpagirecords('pr_seller','*',$conditions);
}
...
<div class="content-wrapper" style="background-color:#fff;">
	<section class="content-header" style="padding:0px;">
		<h1 style="padding-left:20px; padding-top:20px;">Manage Photographer</h1>
		<ol class="breadcrumb">
			<li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="active">Manage Photographer</li>
		</ol>
										...
										<tr>
											...
											<td>
												...
												<div id="inline<?php echo $members->id; ?>" style="width:100%; display: none; margin:auto; padding-top:5px;">
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">First Name</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->firstname; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Last Name</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->lastname; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Business Name</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->business_name; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Phone Number</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->phone_number; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Country</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->country; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">State</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->state; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">City</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->city; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Zip Code</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php echo $members->zip_code; ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Bank Name</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php if(!empty($members->bankname)) { echo $members->bankname; } else {  ?>No Results Found<?php } ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Bank Owner Name</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php if(!empty($members->owner_name)) { echo $members->owner_name; } else {  ?>No Results Found<?php } ?></div>
													<div style="width:50%; float:left; text-align:center; font-size:16px; padding:5px; font-weight:bold;">Bank Number</div>
													<div style="width:50%; float:right; text-align:center; font-size:16px; padding:5px;"><?php if(!empty($members->banknumber)) { echo $members->banknumber; } else {  ?>No Results Found<?php } ?></div>
