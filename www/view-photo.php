...
<div class="container">
	...
	{ 
		...
		{
			?>
			<?php /*<div style="margin-right:30px; margin-bottom:10px; float:right;"><a href="photos.php?gallery=<?php echo base64_encode($view->gallery); ?>&&email=<?php echo $_SESSION['guast']['email']; ?>" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>*/ ?>
			<?php 
		}
		else
		{
			?>
			<?php /*<div style="margin-right:30px; margin-bottom:10px; float:right;"><a href="photos.php?gallery=<?php echo base64_encode($view->gallery); ?>" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>*/ ?>
			<div style="margin-right:30px; margin-bottom:10px; float:right;"><a href="galleries.php" style="padding:10px 40px 10px 40px; background-color:#43ace5; color:#fff; font-weight:bold; border:0px; border-radius:3px; font-size:16px;" >Go Back</a></div>
			<?php
		}
	} 
	?>
	...
	<div class="">
		<div class="col-md-6 no-pading" style="padding-top:15px;">
			<div class="row">
				<img src="<?php echo APP_URL; ?>uploads/photos/bigwatermark/<?php echo $view->webfile; ?>"id="img" alt="Curious Bino" class="img-thumbnail" style = "display: block;max-width: 100%; height: auto;"> 
			</div>
			...
			<div style="padding-left:5px; font-weight:bold; margin-left:10px;">Photo Size : <span style="font-weight:200;"><?php if(!empty($view->imagewidth)) { ?>( Width : <?php echo $view->imagewidth; ?>px, height : <?php echo $view->imageheight; ?>px )<?php }else{ ?>( Width : ..., Height : ... )<?php } ?></span>
			</div>
		...
		<div class="col-md-6 features-right" style="overflow-y: auto; height: 800px; white-space: nowrap; display: block; margin-top:20px; padding-top:0px;">
			...
			$lists = $common->getrecords('pr_photos','*',$conditions) ;
			if(!empty($lists))
			{
				...
				//{
					...
					<div class = 'col-md-4'>
						<a href="view-photo.php?view=<?php echo base64_encode($list->id); ?>"><img src="<?php echo APP_URL; ?>uploads/photos/bigwatermark/<?php echo $list->webfile; ?>" style="display: block;max-width: 100%; height: auto;"/></a>
						<?php 
